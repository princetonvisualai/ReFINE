...
class TaskRunner:
    ...
    def run(self, config):
        ...
        # Load the task reward manager for training and validation.
        if (
...
def create_rl_dataset(data_paths, data_config, tokenizer, processor):
    ...
    from verl.utils.dataset.rl_dataset import TTTRLHFDataset
    ...
    if "custom_cls" in data_config and data_config.custom_cls.get("path", None) is not None:
        ...
        # Use the default TTTRLHFDataset class if no custom class is specified
        dataset_cls = TTTRLHFDataset
